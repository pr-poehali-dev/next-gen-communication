        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Starvell — это платформа для геймеров, которые ценят своё время. Мы собрали тысячи игр, DLC и внутриигровых товаров в одном месте, чтобы ты мог начать играть сразу — без лишних шагов и ожидания.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Неважно, ищешь ли ты новинку или классику, инди-хит или AAA-блокбастер — в Starvell найдётся всё. Мгновенная доставка ключей, честные цены и поддержка, которая всегда на связи.
            </p>
          </div>
        </div>
      </div>
